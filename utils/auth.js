 ...
 * @returns {Promise<{_id: ObjectId, email: string, password: string}>}
 */
export const getUserFromXToken = async (request) => {
...
export default {
  getUserFromAuthorization: async (request) => getUserFromAuthorization(request),
  getUserFromXToken: async (request) => getUserFromXToken(request),
};
